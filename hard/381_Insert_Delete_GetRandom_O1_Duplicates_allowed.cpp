...
// a vector nums
// an unordered_map m
// The key of m is the val, the value of m is a vector contains indices where the
// val appears in nums.
// Each element of nums is a pair, the first element of the pair is val itself,
// the second element of the pair is an index into m[val]. There is a relationship
// between nums and m:
